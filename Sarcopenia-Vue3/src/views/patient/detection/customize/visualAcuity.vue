  ...
  <div class="daily-life-container">
    ...
    <section class="result-area">
      ...
      <div class="result-card score-card">
        ...
        <div class="rc-body">
          <span class="score-big">{{ visionScore }}</span>
      ...
      <div class="result-card score-card">
        ...
        <div class="rc-body">
          <span class="score-big">{{ visualFunctionScore }}</span>
      ...
      <div class="result-card suggest-card combined-suggest">
        ...
        <p class="suggest-text">{{ visionSuggest }} {{ visualFunctionSuggest }}</p>
        <div v-if="abnormalAnswers.length > 0" class="suggest-sub">
          如以上异常项目持续存在，建议尽快眼科专科评估，排查白内障、青光眼、黄斑病变、糖尿病视网膜病变、屈光不正等病因。
        </div>
      </div>
    </section>
...
const visionScore = computed(() => {
  ...
  const option = visionQuestion.optionList.find(o => o.id == optionId)
