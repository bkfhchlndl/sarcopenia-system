  ...
  <div class="sarcopenia-entry">
    <section class="overview-panel">
      <div class="overview-main">
        ...
        <div>
          <div class="section-eyebrow">Sarcopenia Assessment</div>
          <h1>肌少症评估</h1>
          <p>围绕肌肉力量、躯体功能、营养状况等维度，选择适合当前患者的肌少症评估路径。</p>
        </div>
      </div>
    ...
    >
      <div class="guide-dialog">
        ...
        <p class="guide-desc">
          当前肌少症评估页面没有收到患者ID，无法把评估结果保存到具体患者名下。请先新建患者，或从用户管理列表点击"进入测试"。
        </p>
...
import { User, UserFilled, ArrowLeft, Odometer, ArrowRightBold, InfoFilled, Close } from '@element-plus/icons-vue'
...
const assessmentTypes = [
  {
    code: 'sarcopenia_complete',
    title: '肌少症完整评估',
    subtitle: 'Complete Sarcopenia Assessment',
    icon: '🧪',
    color: '#f59e0b',
  ...
  },
  {
    ...
    title: '自定义单项筛查',
    subtitle: 'Custom Single Screening',
    icon: '✏️',
    color: '#8b5cf6',
    tags: ['自由选择', '单项评估', '灵活配置'],
    desc: '从单项量表中按需选择，适合专项补充、复评或只筛查某一维度。',
    route: { path: '/patient/detection/sCustomize' }
  }
]
